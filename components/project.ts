const project = [
  {
    ...
    desc: 'Freshly Dropped is a food service that delivers freshly picked meal boxes for you to prepare at home. an app that can serve people to get all the food’s ingredient, customers can select the recipes that they need.',
    imageLink: '/freshly_dropped.png',
    url: 'https://github.com/zeph1re/FreshlyDropped',
  },
  {
    title: 'Rinengga App',
